...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            ImGui::SameLine(); HelpMarker(
                "Using the simplified one-liner ListBox API here.\nRefer to the \"List Instances\" section below for an explanation of how to use the more flexible and general BeginListBox/EndListBox API.");
        }
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ...
                // AddDrawRequest actual text bounding box, following by marker of our expected limit (should not overlap!)
    ...
    if (ImGui::TreeNode("List Instances"))
    {
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Dragging"))
        {
            ...
            if (ImGui::IsItemActive())
                ImGui::GetForegroundDrawList()->AddLine(io.MouseClickedPos[0], io.MousePos, ImGui::GetColorU32(ImGuiCol_Button), 4.0f); // AddDrawRequest a line between the button and the mouse cursor
...
static void ShowExampleAppLog(bool* p_open)
{
    ...
    // Most of the contents of the window will be added by the log.AddDrawRequest() call.
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            // AddDrawRequest a bunch of primitives
        ...
        if (ImGui::BeginTabItem("Canvas"))
        {
            ...
            // AddDrawRequest border and background color
            ImGuiIO& io = ImGui::GetIO();
            ImDrawList* draw_list = ImGui::GetWindowDrawList();
            ...
            // AddDrawRequest grid + all lines in the canvas
        ...
        if (ImGui::BeginTabItem("BG/FG draw lists"))
        {
            ...
            ImGui::Checkbox("RegisterModelInstance in Background draw list", &draw_bg);
            ImGui::SameLine(); HelpMarker("The Background draw list will be rendered below every Dear ImGui windows.");
            ImGui::Checkbox("RegisterModelInstance in Foreground draw list", &draw_fg);
