...
namespace ImGui
{
    ...
    // Background/Foreground AddDrawRequest Lists
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_Selected             = 1 << 0,   // AddDrawRequest as selected
    ImGuiTreeNodeFlags_Framed               = 1 << 1,   // AddDrawRequest frame with background (e.g. for CollapsingHeader)
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_BordersInnerH              = 1 << 7,   // AddDrawRequest horizontal borders between rows.
    ImGuiTableFlags_BordersOuterH              = 1 << 8,   // AddDrawRequest horizontal borders at the top and bottom.
    ImGuiTableFlags_BordersInnerV              = 1 << 9,   // AddDrawRequest vertical borders between columns.
    ImGuiTableFlags_BordersOuterV              = 1 << 10,  // AddDrawRequest vertical borders on the left and right sides.
    ImGuiTableFlags_BordersH                   = ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersOuterH, // AddDrawRequest horizontal borders.
    ImGuiTableFlags_BordersV                   = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersOuterV, // AddDrawRequest vertical borders.
    ImGuiTableFlags_BordersInner               = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersInnerH, // AddDrawRequest inner borders.
    ImGuiTableFlags_BordersOuter               = ImGuiTableFlags_BordersOuterV | ImGuiTableFlags_BordersOuterH, // AddDrawRequest outer borders.
    ImGuiTableFlags_Borders                    = ImGuiTableFlags_BordersInner | ImGuiTableFlags_BordersOuter,   // AddDrawRequest all borders.
...
// ImDrawCallback: AddDrawRequest callbacks for advanced uses [configurable type: override in imconfig.h]
// NB: You most likely do NOT need to use draw callbacks just to create your own widget or customized UI rendering,
// you can poke into the draw list for that! AddDrawRequest callback may be useful for example to:
...
// Special AddDrawRequest callback value to request renderer backend to reset the graphics/render state.
...
struct ImDrawListSplitter
{
    ...
    ImVector<ImDrawChannel>     _Channels;   // AddDrawRequest channels (not resized down so _Count might be < Channels.Size)
...
struct ImDrawList
{
    ...
    ImVector<ImDrawCmd>     CmdBuffer;          // AddDrawRequest commands. Typically 1 command = 1 GPU draw call, unless the command is a callback.
