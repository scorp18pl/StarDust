...
enum ImGuiNavHighlightFlags_
{
    ...
    ImGuiNavHighlightFlags_AlwaysDraw       = 1 << 2,       // AddDrawRequest rectangular highlight if (g.NavId == id) _even_ when using the mouse.
...
struct ImGuiTableColumn
{
    ...
    ImGuiTableDrawChannelIdx DrawChannelFrozen;             // AddDrawRequest channels for frozen rows (often headers)
    ImGuiTableDrawChannelIdx DrawChannelUnfrozen;           // AddDrawRequest channels for unfrozen rows
